...
//     if (days > user.availableLeaves) {
//       return NextResponse.json({ 
//         msg: `Insufficient leave balance. You have ${user.availableLeaves} days available, but requested ${days} days.`,
//         availableLeaves: user.availableLeaves,
//         requestedDays: days
//       }, { status: 400 });
//     }
...
//       leave,
//       message: "Leave request submitted successfully",
//       remainingLeaves: user.availableLeaves // Show current balance (will be updated when leave is approved)
//     }, { status: 201 });
//   } catch (err) {
//     console.error('Error creating leave:', err);
//     return NextResponse.json({ error: err.message }, { status: 500 });
